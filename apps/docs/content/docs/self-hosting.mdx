...
<Callout variant="warning">🛠️  This guide assumes you have basic familiarity with the Linux command line and package managers like **pnpm**.</Callout>
...
## 3. Running with Docker Compose (Database Only)
...
## 6. Deploying to Vercel (Cloud Option)
...
<Callout variant="success">🎉  That’s it — you now own the full Harmony stack!</Callout> 