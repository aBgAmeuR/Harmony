...
export const DetailTabsContent = ({ children, value, className }: DetailTabsContentProps) => {
    return (
        <TabsContent value={value} className={cn("mx-auto w-full max-w-7xl space-y-4 px-4 py-2", className)}>
            {children}
        </TabsContent>
    )
}