...
export function TimeListenedChartComponent({
  ...
  return (
    <ChartCard className={className}>
      <ChartCardHeader showSeparator title="Time Listened Over Months" description="Showing total time listened in hours over the months">
        <ChartCardHeaderContent title="Average time listened" description={headerDescription} />
      </ChartCardHeader>
      <ChartCardContent>
        <ReusableBarChart
          data={chartData.data}
...
export function TimeListenedChartSkeleton({ className }: { className?: string }) {
  return (
    <ChartCard className={className}>
      <ChartCardHeader showSeparator title="Time Listened Over Months" description="Showing total time listened in hours over the months">
        <ChartCardHeaderContent title="Average time listened" description={<Skeleton className="mt-2 py-px">00,00 hours</Skeleton>} />
      </ChartCardHeader>
      <ChartCardContent>
