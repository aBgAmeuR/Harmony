...
export const InteractiveComparisonsSection = () => {
    return (
        <div className="flex w-full flex-col gap-6 py-12">
            <Tabs
                defaultValue="numbers"
                orientation="vertical"
                className="w-full flex-col justify-between gap-6 md:flex-row md:gap-0"
            >
...
export function MonthlyEvolution() {
    ...
    return (
        <div className="flex flex-1">
            <ReusableLineChart
                data={data}
                className="aspect-[3/1] size-full md:aspect-[5/2]"
                xAxisDataKey="month"
