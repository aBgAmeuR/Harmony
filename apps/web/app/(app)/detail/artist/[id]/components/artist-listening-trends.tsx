...
export function ArtistListeningTrends({ stats }: ArtistListeningTrendsProps) {
  ...
  return (
    <div className="grid xl:grid-cols-2 gap-4 w-full">
      <ChartCard>
        <ChartCardHeader showSeparator title="Monthly Listening Activity" description="Total time listened in hours over the months" />
        <ChartCardContent>
          <ReusableAreaChart
      ...
      <ChartCard>
        <ChartCardHeader showSeparator title="Listening Patterns" description="When you listen most during the day" />
        <ChartCardContent>
          <ReusableBarChart
