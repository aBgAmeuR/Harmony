...
function SidebarMenuSub({ className, ...props }: React.ComponentProps<"ul">) {
	return (
		<ul
			...
			className={cn(
				"display-grid grid-template-rows-0fr mx-3.5 flex min-w-0 translate-x-px flex-col gap-1 border-sidebar-border border-l px-2.5 py-0.5 transition-[grid-template-rows] duration-500 ease-in-out",
				"group-data-[collapsible!=icon]:grid-template-rows-1fr group-data-[collapsible=icon]:overflow-hidden",
				className,
			)}
			{...props}
		/>
