...
export interface ChartRaceProps extends Omit<BaseChartProps, 'data'>, AxisTickFormatters {
    ...
    <ChartContainer config={config} className={className}>
      <LineChart>
        ...
        <ChartTooltip
          ...
          content={<ChartTooltipContent labelFormatter={(label, payload) => getTooltipFormatter(tooltipLabelFormatter, label, payload, null)} formatter={getChartTooltipFormatter(tooltipValueFormatter)} />}
        />
